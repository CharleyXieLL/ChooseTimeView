...
import lei.choosetimeview.wheelview.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	//*/
	private int[] SHADOWS_COLORS = new int[] { 0xefdad5da,
			0xcfdad5da, 0x3fdad5da };
	...
	// Wheel drawables
	private int wheelBackground = R.drawable.yq_wheel_bg;
	private int wheelForeground = R.drawable.yq_wheel_val;
